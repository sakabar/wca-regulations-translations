...
- B2d+) [追記] 基本的に最初の試技では、競技者はジャッジの準備ができていることを確認してから試技を始める（参照：[Regulation B2a](regulations:regulation:B2a)）。もし競技者がタイマーが正常に動作するかを確認したい場合は、競技者は毎回タイマーをスタートしたりリセットしたりする前にジャッジに質問し、確認をとらなければならない。ジャッジへの確認なしにタイマーをスタートしたりリセットしたりした場合の罰則：試技の失格（DNF）。
